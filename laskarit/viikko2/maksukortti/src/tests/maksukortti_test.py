...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_edullisen_lounaan_ostaminen_onnistuu_kun_saldo_tasan_hinnan_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def test_maukkaan_lounaan_ostaminen_onnistuu_kun_saldoa_tasan_hinnan_verran(self):
